(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LogonService = /** @class */ (function () {
                 ...
                 * @return {?}
                 */
                LogonService.prototype.setHost = function (host) {
                    this.host = host;
                };
                /**
                 * @param {?} userid
                 ...
                 * @return {?}
                 */
                LogonService.prototype.logon = function (userid, password) {
                 ...
                 * @return {?}
                 */
                LogonService.prototype.logout = function () {
                 ...
                 * @return {?}
                 */
                LogonService.prototype.session = function () {
                 ...
                 * @return {?}
                 */
                LogonService.prototype.query = function (queryObject) {
                 ...
                 * @return {?}
                 */
                LogonService.prototype.read = function (instanceGUID) {
                 ...
                 * @return {?}
                 */
                LogonService.prototype.handleError = function (operation, result) {
                    var _this = this;
                     ...
                     */function (error) {
                        ...
                        _this.messageService.addMessage('EXCEPTION', 'GENERIC', ui_message_angular__WEBPACK_IMPORTED_MODULE_2__["messageType"].Exception, JSON.stringify(error));
            ...
            var LogonComponent = /** @class */ (function () {
                 ...
                 * @return {?}
                 */
                LogonComponent.prototype.ngOnDestroy = function () {
                 ...
                 * @return {?}
                 */
                LogonComponent.prototype.logon = function () {
                    var _this = this;
                    this.isWaiting = true;
                     ...
                     */ data) {
                        ...
                        if (data.err) {
                            if (Array.isArray(data.err)) {
                                 ...
                                 * @param {?} err
                                 * @return {?}
                                 */ err) { return _this.messageService.add(err); }));
                            }
                            else {
            ...
            var LandingPageComponent = /** @class */ (function () {
                 ...
                 * @return {?}
                 */
                LandingPageComponent.prototype.session = function () {
                    var _this = this;
                 ...
                 * @return {?}
                 */
                LandingPageComponent.prototype.query = function () {
                    var _this = this;
                    /** @type {?} */
                     ...
                     * @param {?} data
                     * @return {?}
                     */ data) { return _this.result = data; }));
                };
                /**
                 * @return {?}
                 */
                LandingPageComponent.prototype.read = function () {
                    var _this = this;
