...
/* harmony import */ var jor_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! jor-angular */ "./node_modules/jor-angular/fesm2015/jor-angular.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
], UserAddressComponent.prototype, "relationMetas", void 0);
UserAddressComponent = __decorate([
    ...
    __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"],
        jor_angular__WEBPACK_IMPORTED_MODULE_2__["AttributeControlService"]])
...
UserBasicComponent.ctorParameters = () => [
    { type: jor_angular__WEBPACK_IMPORTED_MODULE_2__["AttributeControlService"] }
];
__decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
...
__decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
    __metadata("design:type", Array)
], UserBasicComponent.prototype, "relationMetas", void 0);
UserBasicComponent = __decorate([
    ...
    __metadata("design:paramtypes", [jor_angular__WEBPACK_IMPORTED_MODULE_2__["AttributeControlService"]])
], UserBasicComponent);
...
let UserDetailComponent = class UserDetailComponent {
    constructor(fb, route, router, dialogService, identityService, entityService, uiMapperService, messageService) {
        this.fb = fb;
        this.route = route;
        this.router = router;
    ...
    ngOnInit() {
        this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])((params) => {
            ...
            if (this.action === 'new') {
                this.isNewMode = true;
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["forkJoin"])(this.entityService.getRelationMetaOfEntity('person'), this._createNewUser());
            }
            else {
                this.isNewMode = false;
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["forkJoin"])(this.entityService.getRelationMetaOfEntity('person'), this.identityService.getUserDetail(params.get('userID')));
            }
        })).subscribe(data => {
...
__decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
    __metadata("design:type", Array)
], UserEmailComponent.prototype, "relationMetas", void 0);
UserEmailComponent = __decorate([
    ...
    __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"],
        ...
        jor_angular__WEBPACK_IMPORTED_MODULE_3__["AttributeControlService"]])
], UserEmailComponent);
...
UserPersonalizationComponent.ctorParameters = () => [
    { type: jor_angular__WEBPACK_IMPORTED_MODULE_2__["AttributeControlService"] }
];
__decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
...
__decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
    __metadata("design:type", Array)
], UserPersonalizationComponent.prototype, "relationMetas", void 0);
